...
public interface ICommonDao
{
     ...
     * @throws Exception
     */
    public <T> List<T> queryBusinessObjs(Class<T> cls, final String sql, final int startRecord, final int maxRecord, final SqlParameter... params)
            throws SQLException;
     ...
     * @throws Exception
     */
    public <T> PaginationSupport<T> queryByPagedQuery(Class<T> cls, final String sql, final int startPage, final int pageSize,
     ...
     * @throws SQLException
     */
    public <T> PaginationSupport<T> queryByPagedQuery(Class<T> cls, final String countsql, final String sql, final int startPage, final int pageSize,
            final SqlParameter... params) throws SQLException;
