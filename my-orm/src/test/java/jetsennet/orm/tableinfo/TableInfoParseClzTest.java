...
public class TableInfoParseClzTest extends TestCase
{
    ...
    {
        TableInfo info = TableInfoParseClz.parse(TestEntity.class);
        assertNotNull(info);
        ...
        assertEquals(KeyGenEnum.DB, field.getKeyEnum());
        ...
        assertEquals(true, field.isKey());
        assertEquals("UUID", field.getKeyGen());
        assertEquals(KeyGenEnum.GUID, field.getKeyEnum());
