 ...
 * @author 梁洪杰
 */
@Table(name = "BMP_PERFDATADAY")
public class PerfDataDayEntity
{
    /**
     * 对象属性ID
     */
    ...
    {
        return String.format("SELECT * FROM BMP_PERFDATADAY WHERE COLL_TIME<%s", time);
    }
    ...
    {
        return String.format("DELETE FROM BMP_PERFDATADAY WHERE COLL_TIME<%s", time);
    }
}
