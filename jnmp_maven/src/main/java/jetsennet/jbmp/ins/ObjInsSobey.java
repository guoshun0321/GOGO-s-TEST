...
import jetsennet.jbmp.ins.helper.AttrsInsSobey;
 ...
 * @author 郭祥
 */
public class ObjInsSobey extends AbsObjIns {

	public final Logger logger = Logger.getLogger(ObjInsSobey.class);
	...
	protected void initInsClasses() {
		...
		AttrsInsSobey sins = new AttrsInsSobey();
		inss.add(sins);
