...
import jetsennet.jbmp.log.SwingReg;
...
public class BaseMgrFrm extends javax.swing.JFrame
{
    ...
    protected void initComponents()
    {
        ...
        exitMenuItem.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                int result =
                    JOptionPane.showOptionDialog(null, "确认退出？", "退出", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options,
                        options[0]);
                if (result == 0)
                {
                    logger.info("正在准备关闭...");
        ...
        logPanel.add(logScrollPane, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.BOTH, new Insets(0, 0,
            0, 0), 0, 0));
        jPanel1.add(tabPanel, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0),
            0, 0));
        con
            .add(jPanel1,
                new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    }
    ...
    {
        SwingReg reg = SwingReg.getInstance();
        reg.reg("Test", logModel);
