...
作 者:
版 本: v1.3
描 述: 用于解析FTP结果，源于OpenNMS项目org.opennms.netmgt.capsd.plugins.FtpResponse
历 史:
 ************************************************************************/
...
public class FtpResponse
{
     ...
     * @return True if the response code is between 100 and 599, false otherwise.
     */
     ...
     * @return True if the response code is between 200 and 299, false otherwise.
     */
     ...
     * @return True if the response code is between 300 and 399, false otherwise.
     */
    ...
    public static FtpResponse readResponse(BufferedReader in) throws IOException
    {
        ...
        if ("-".equals(firstResponseLine.substring(3, 4)))
        {
            ...
            while (true)
            {
                ...
                {
                    throw new IOException("End of stream was reached before the complete multi-line response could be read.  What was read: ");
                }
