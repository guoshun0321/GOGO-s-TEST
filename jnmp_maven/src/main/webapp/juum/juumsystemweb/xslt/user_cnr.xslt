    ...
    <table cellspacing="0" cellpadding="1" style="width:98%;" ID="tabUser">
      <tr>
        <td align="center" width="30px">
          <input type="checkbox" onclick="JetsenWeb.Form.checkAllItems('chkUser',this.checked)" id="chkCheckAllUser_cnr"></input>
        </td>
        ...
        <td width="80px" align="center" sortfield="CREATE_TIME">
          <b>创建时间</b>
        </td>
      ...
      <xsl:for-each select="RecordSet/Record">
        <tr ondblclick="editUser('{ID}');">
          <td align="center">
            <input type="checkbox" name="chkUser" onclick="$('chkCheckAllUser_cnr').checked=false;" value="{ID}"></input>
          </td>
          <td align="left">
