...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	<xsl:template match="/">
		<table id="tabProject"  border="0" cellspacing="0" cellpadding="2" width="97.3%" >
			<colgroup>
				<col width="60px"></col>
				<col width="150px"></col>
				<col width="60px"></col>
					...
					<td>
						<xsl:choose>
							<xsl:when test="string-length(PROJECT_ATTACHMENT)&gt;0">
								<a href="javascript:void(0);" onclick="showAttachmentList('{PROJECT_ATTACHMENT}', '{PROJECT_ATTACHMENT_PATH}', {PROJECT_ID}); return false;" target="_blank">下载</a>
							</xsl:when>
							<xsl:otherwise>
								无
							</xsl:otherwise>
