		...
		<table id="objTableList" border="0" cellspacing="0" cellpadding="2"
			...
			<xsl:for-each select="RecordSet/Record">
				<tr height="20" ondblclick="editElement('{OBJ_ID}','{CLASS_ID}','{CLASS_TYPE}')"  width="40px"
					onclick="getEquipType('{CLASS_ID}')" align="center">
					<td align="center">
						<input type="checkbox" name="chkAllObject"
							onclick="$('chkCheckAll').checked=false" value="{OBJ_ID}"></input>
					</td>
					<td align="left">
					...
					<td align="center">
						<a href="javascript:void(0)" onclick="editElement('{OBJ_ID}','{CLASS_ID}','{CLASS_TYPE}')">
							<img border="0" src="images/edit.gif" />
						</a>
					</td>
					<td align="center" width="35px">
						<a hreg="javascript:void(0)" onclick="delElement('{OBJ_ID}')">
