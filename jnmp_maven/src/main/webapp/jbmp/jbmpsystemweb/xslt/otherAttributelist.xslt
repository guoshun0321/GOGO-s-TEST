...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<table id="otherattributeList" border="0" cellspacing="0"
			...
			<tr>
				<td align="center" width="30px">
					<input type="checkbox"
						onclick="JetsenWeb.Form.checkAllItems('checkObjAttr2Alarmother',this.checked)"
						id="chkCheckAllObjAttr8"></input>
				</td>
			...
			<xsl:for-each select="RecordSet/Record">
				<tr height="20" ondblclick="editTimeSpanObjAttr('{OBJATTR_ID}','104,105,107')">
					<td align="center">
						<input type="checkbox" name="checkObjAttr2Alarmother"
							onclick="$('chkCheckAllObjAttr8').checked=false;" value="{OBJATTR_ID}"></input>
					...
					<td align="center">
						<a href="javascript:void(0)" onclick="editTimeSpanObjAttr('{OBJATTR_ID}','104,105,107')">
							<img border="0" src="images/edit.gif" />
						</a>
					</td>
					<td align="center">
						<a hreg="javascript:void(0)" onclick="deleteObjAttr('{OBJATTR_ID}','104,105,107')">
