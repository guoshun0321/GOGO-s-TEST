	...
	<xsl:template match="/">
		<table id="tabAlarmLevel" border="0" cellspacing="0"
			...
			<xsl:for-each select="RecordSet/Record">
				<tr height="20" ondblclick="generalAlarmConfig.editLevel('{LEVEL_ID}')">
					<td>
					...
					<td align="center">
						<a href="javascript:void(0)" onclick="generalAlarmConfig.editLevel('{LEVEL_ID}')">
							<img border="0" src="images/edit.gif" />
						</a>
					</td>
					<td align="center">
						<img style="cursor:pointer" title="删除" src="images/drop.gif"
							onclick="generalAlarmConfig.delLevel('{LEVEL_ID}');" />
					</td>
				</tr>
			</xsl:for-each>
		</table>
