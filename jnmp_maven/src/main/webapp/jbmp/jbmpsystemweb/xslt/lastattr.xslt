...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<table id="lastAttrTable" border="0" cellspacing="0" cellpadding="2" width="98%">
			<tr>
			...
			<xsl:for-each select="RecordSet/Record">
				<tr height="20">
					...
					<td align="center">
						<!-- <input type="checkbox" onchange="selLastAttr1(this,'{ATTRIB_ID}');" />-->
						<input type="checkbox" onchange="selecteNoInsAttr(this, '{ATTRIB_ID}');" />
					</td>
				</tr>
			</xsl:for-each>
		</table>
