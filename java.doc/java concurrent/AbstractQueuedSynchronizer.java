...
public abstract class AbstractQueuedSynchronizer extends AbstractOwnableSynchronizer implements java.io.Serializable
{
    ...
    static final class Node
    {
        ...
        /**
         * SINGAL ：后续节点处于阻塞状态，需要前置节点在release或cancel的时候unpark后续节点
         * CANCELLED ：节点由于timeout或interrupt取消。处于该状态的节点，不能变换到其他状态
         * CONDITION : 节点处于条件队列，在并发队列中不起作用。在转换到并发队列后，状态设置为0.
         * PROPAGATE ：releaseShared会被传播给其他节点。再有在head节点的doReleaseShared操作中设置后会传播下去。
         * 
    ...
    private void cancelAcquire(Node node)
    {
        ...
        // 如果是未节点，尝试将pred设置为尾节点，然后尝试将pred的next设置为null
    ...
    private static boolean shouldParkAfterFailedAcquire(Node pred, Node node)
    {
        ...
        else
        {
             ...
             * 
             * 当前辈的状态为0或者PROPAGATE时，尝试将前辈的状态修改为SIGNAL
             */
