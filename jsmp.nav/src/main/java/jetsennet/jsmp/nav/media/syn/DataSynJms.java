...
import jetsennet.jsmp.nav.media.jms.JmsMsgHandle;
...
public class DataSynJms
{
	 ...
	 * 日志
	 */
	private static final Logger logger = LoggerFactory.getLogger(DataSynJms.class);

	public static final DataSynJms instance = new DataSynJms();

	private DataSynJms()
	{
	}

	public static DataSynJms getInstance()
	{
		return instance;
	}
